...
-- Q30
(@cat_reg, 'A Lei de Abuso de Autoridade (Lei 4.898/65) visava proteger tanto a Administração Pública quanto os direitos fundamentais. Constituía atentado à liberdade de locomoção, segundo a referida lei:', 'Realizar abordagem preventiva fundamentada em elementos objetivos de suspeita.', 'Exigir que o condutor de veículo apresente a Carteira Nacional de Habilitação.', 'Solicitar a identificação civil de pessoas em atitude suspeita em via pública.', 'Prender criminoso em flagrante delito dentro do domicílio durante o dia.', 'Ordenar ou executar medida privativa da liberdade individual sem as formalidades legais ou com abuso de poder.',
 'E', 'Justificativa doutrinária (apostila): a antiga Lei 4.898/65 tipificava como abuso a medida privativa de liberdade sem formalidades legais ou com abuso de poder. Abordagens fundadas em elementos objetivos são deveres legais do policial, não abuso.

📜 Fundamento legal vigente: ATENÇÃO — a Lei 4.898/1965 citada no enunciado está REVOGADA desde 3/1/2020 pela Lei 13.869/2019 (art. 44), que passou a disciplinar integralmente o abuso de autoridade. O dispositivo correspondente hoje é o art. 9º da Lei 13.869/2019: "Decretar medida de privação da liberdade em manifesta desconformidade com as hipóteses legais: Pena - detenção, de 1 (um) a 4 (quatro) anos, e multa." Qualquer aplicação prática deve invocar a lei vigente, não a de 1965.', 'Lei 13.869/2019, art. 9º (revogou a Lei 4.898/1965, art. 4º)', 'medio');
